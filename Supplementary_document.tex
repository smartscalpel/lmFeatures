...
The model has two type of output: `g' for accepted features and `b' for
rejected. The result of our feature is `g', so it is accepted.
...
\includegraphics{Supplementary_document_files/figure-latex/get.quality.646.30-1.pdf}

\begin{verbatim}
## NULL
\end{verbatim}

\includegraphics{Supplementary_document_files/figure-latex/get.quality.646.30-2.pdf}
